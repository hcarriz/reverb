...
// Diff compreverb the state read from a database connection or migration directory with
...
// NamedDiff compreverb the state read from a database connection or migration directory with
